    ...
    <div class="row">
        <div class="col-md text-center">
            ...
            <asp:SqlDataSource ID="HeaderDS"
                runat="server"
                ConnectionString='<%$ ConnectionStrings:ConnectionToPoweredPIK %>'
                ProviderName='<%$ ConnectionStrings:ConnectionToPoweredPIK.ProviderName %>'
...
<%--            2. put this back in your detail grid view
            ...
            <dx:ASPxGridView ID="DetailGridview" runat="server" DataSourceID="DetailDS" AutoGenerateColumns="False" KeyFieldName="Container_ID" OnCustomCallback="DetailGridview_CustomCallback" OnBeforePerformDataSelect="DetailGrid_BeforePerformDataSelect" ClientInstanceName="DetailGridview" CssClass="centered">
                <Settings ShowTitlePanel="true" ShowFilterRow="true" />
    ...
    <br />
    <div class="row">
<%--        3. put this back in your allocation grid
         OnBeforePerformDataSelect="AllocationGrid_BeforePerformDataSelect"--%>
        <dx:ASPxGridView ID="AllocationDetailGridview" runat="server" DataSourceID="AllocationDetailDS" AutoGenerateColumns="False" KeyFieldName="seq_#" ClientInstanceName="AllocationDetailGridview"
           OnBeforePerformDataSelect="AllocationGrid_BeforePerformDataSelect" OnCustomCallback="AllocationDetailGridview_CustomCallback">
            <Settings ShowTitlePanel="true" ShowFilterRow="true" />
